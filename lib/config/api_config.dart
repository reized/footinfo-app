...
class ApiConfig {
  ...
  static String get footballApiBaseUrl => dotenv.env['FOOTBALL_API_BASE_URL'] ?? '';
  ...
  static Future<void> initialize() async {
    try {
      ...
      if (debugMode) {
        ...
        print('API Key: ${footballApiKey.isNotEmpty ? '***configured***' : 'NOT CONFIGURED'}');
      }
    } catch (e) {
  ...
  static bool validateConfig() {
    final isValid = footballApiBaseUrl.isNotEmpty && 
    ...
    if (!isValid && debugMode) {
      ...
      if (footballApiBaseUrl.isEmpty) print('- FOOTBALL_API_BASE_URL is missing');
